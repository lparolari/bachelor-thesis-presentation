...
predicati del primo ordine, per applicazioni general purpose. Picat è
l'acronimo delle caratteristiche che lui stesso offre. Senza scendere
in dettagli tecnici, Picat propone come punti di forza l'essere basato
su pattern matching, ovvero le regole applcabili ad una certa chiamata
vengono tramite il pattern matching, l'essere intuitivo fornendo
costrutti comunemente utilizzato in linguaggi imperativi, il supporto
nativo della programmazione con vincoli, il supporto della
programmazione di attori event-driven e il supporto di meccanismi di
caching in maniera trasparente.
